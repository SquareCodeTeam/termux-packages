...
# Default value: `termux`
##
TERMUX__REPOS_HOST_ORG_NAME="SquareCodeTeam"
...
# - https://github.com/termux/termux-packages/wiki/Termux-file-system-layout#termux-private-app-data-directory
#
# Default value: `ide.square.app`
##
TERMUX_APP__PACKAGE_NAME="ide.square.app"
...
#
# Default value: `/data/data/ide.square.app`
##
...
#
# Default value: `/data/data/ide.square.app/termux`
##
...
#
# Default value: `/data/data/ide.square.app/termux/core`
##
...
#
# Default value: `/data/data/ide.square.app/termux/app`
##
...
#
# Default value: `/data/data/ide.square.app/termux/app/i`
##
...
# `TERMUX__APPS_DIR`.
#
# Default value: `/data/data/ide.square.app/termux/app/u`
##
...
#
# Default value: `/data/data/ide.square.app/files`
##
...
#
# Default value: `/data/data/ide.square.app/files/home`
##
...
#
# Default value: `/data/data/ide.square.app/files/home/.termux`
##
...
#
# Default value: `/data/data/ide.square.app/files/usr`
##
...
#
# Default value: `/data/data/ide.square.app/files/usr/glibc`
##
...
#
# Default value: `/data/data/ide.square.app/files/usr/bin`
##
...
#
# Default value: `/data/data/ide.square.app/files/usr/etc`
##
...
#
# Default value: `/data/data/ide.square.app/files/usr/include`
##
...
#
# Default value: `/data/data/ide.square.app/files/usr/include32`
##
...
#
# Default value: `/data/data/ide.square.app/files/usr/include` (`$TERMUX__PREFIX__BASE_INCLUDE_DIR`)
##
...
#
# Default value: `/data/data/ide.square.app/files/usr/lib`
##
...
#
# Default value: `/data/data/ide.square.app/files/usr/lib32`
##
...
#
# Default value: `/data/data/ide.square.app/files/usr/lib` (`$TERMUX__PREFIX__BASE_LIB_DIR`)
##
...
#
# Default value: `/data/data/ide.square.app/files/usr/libexec`
##
...
#
# Default value: `/data/data/ide.square.app/files/usr/opt`
##
...
#
# Default value: `/data/data/ide.square.app/files/usr/share`
##
...
#
# Default value: `/data/data/ide.square.app/files/usr/var`
##
...
#
# Default value: `/data/data/ide.square.app/files/usr/tmp`
##
...
#
# Default value: `/data/data/ide.square.app/files/usr/etc/profile.d`
##
...
#
# Default value: `/data/data/ide.square.app/files/usr/etc/termux`
##
...
#
# Default value: `/data/data/ide.square.app/cache`
##
...
#
# Default value: `/data/data/ide.square.app/files/usr/etc/termux/termux-bootstrap`
##
...
#
# Default value: `/data/data/ide.square.app/files/usr/etc/termux/termux-bootstrap/second-stage`
##
...
##
TERMUX_APP__APP_IDENTIFIER="squareide"
...
# Default value: `ide.square.app`
##
TERMUX_APP__NAMESPACE="ide.square.app"
...
#
# Default value: `/data/data/ide.square.app/termux/app/i/termux`
##
...
#
# Default value: `ide.square.app.app.TermuxActivity`
##
...
#
# Default value: `ide.square.app.app.TermuxService`
##
...
#
# Default value: `ide.square.app.app.RunCommandService`
##
...
#
# Default value: `ide.square.app.app.TermuxOpenReceiver`
##
...
#
# Default value: `/data/data/ide.square.app/termux/app/i/termux/termux-apps-info.env`
##
...
#
# Default value: `/data/data/ide.square.app/termux/app/i/termux/termux-apps-info.json`
##
...
#
# Default value: `/data/data/ide.square.app/termux/app/i/termux/termux-am`
##
...
# - https://github.com/termux/termux-packages/wiki/Termux-file-system-layout#termux-private-app-data-directory
#
# Default value: `ide.square.app.api`
##
TERMUX_API_APP__PACKAGE_NAME="ide.square.app.api"
...
# Default value: `ide.square.app.api`
##
TERMUX_API_APP__NAMESPACE="ide.square.app.api"
...
#
# Default value: `/data/data/ide.square.app/termux/app/i/termuxapi`
##
...
#
# Default value: `ide.square.app.api.TermuxApiReceiver`
##
...
#
# Constant value: `ide.square.app.termuxam`
##
TERMUX_AM_APP__NAMESPACE="ide.square.app.termuxam"
...
#
# Default value: `ide.square.app.termuxam.Am`
##
...
TERMUX_REPO_APP__PACKAGE_NAME="ide.square.app"
TERMUX_REPO_APP__DATA_DIR="/data/data/ide.square.app"
TERMUX_REPO__CORE_DIR="/data/data/ide.square.app/termux/core"
TERMUX_REPO__APPS_DIR="/data/data/ide.square.app/termux/app"
TERMUX_REPO__ROOTFS="/data/data/ide.square.app/files"
TERMUX_REPO__HOME="/data/data/ide.square.app/files/home"
TERMUX_REPO__PREFIX="/data/data/ide.square.app/files/usr"
